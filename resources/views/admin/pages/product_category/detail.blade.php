                            ...
                            <form role="form" method="post"
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="slug" value="{{ old('slug') ?? $data->slug }}"
                                            name='slug' class="form-control" id="exampleInputSLug" placeholder="Slug">
                                        @error('slug')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <select name="status" id="">
                                            ...
                                            <option value="1"
                                                {{ (old('status') ?? $data->status) == 1 ? 'selected' : '' }}>Show</option>
                                            <option value="0"
                                                {{ (old('status') ?? $data->status) == 0 ? 'selected' : '' }}>Hide</option>
                                        </select>
                                        @error('status')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
